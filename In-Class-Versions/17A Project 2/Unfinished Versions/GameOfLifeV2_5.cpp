 ...
 *                      
 *                      Main Focus:
 *                          implement card vector in Player class
 *                          make Card class abstract and make derived classes polymorph the virtual function
 *                          Fixing up code to work with the classes
 *                          Learning STL library stuff       
 */
...
//===================================================================------FILE FUNCTIONS------=====================================================================================
/**
 * @brief      (For all the fRead functions) The File Reading Functions for the object arrays.
 * 
 * @param name The name of the file that is being read form
 * @param arr  Array of the designeted object/class type
 ...
 * @return Player* Return Array of Players
 */
